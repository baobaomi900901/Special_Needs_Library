...
const roleParent = [
    {
        id: 500001,
        department: 200001, // 产品中心
        parent_id: 0, // 父级id
        parent_level: 0, // 父级级别
    },
    {
        id: 500002,
        department: 200002, // 产品中心
        parent_id: 200001, // 父级id
        parent_level: 1, // 父级级别
    },
    {
        id: 500003,
        department: 200003, // 产品中心
        parent_id: 200001, // 父级id
        parent_level: 1, // 父级级别
    },
    {
        id: 500004,
        department: 200004, // 产品中心
        parent_id: 200001, // 父级id
        parent_level: 1, // 父级级别
    },
    {
        id: 500005,
        department: 200005, // 产品中心
        parent_id: 200004, // 父级id
        parent_level: 2, // 父级级别
    },
]
